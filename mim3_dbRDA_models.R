...
BiocManager::install(c("vegan")) #, "tidyverse"))
...
save(m0_hell, file.path(path, file = "clean_data/statistics/m0_hell.rda"))
...
save(m1_hell, file.path(path, file = "clean_data/statistics/m1_hell.rda"))
...
save(m2_hell, file.path(path, file = "clean_data/statistics/m2_hell.rda"))
...
save(anova_m2_hell, file.path(path, file = "clean_data/statistics/m2_hell.rda"))
