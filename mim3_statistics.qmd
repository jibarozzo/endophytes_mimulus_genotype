...
pseq_rrfa <- readRDS(file.path(path, "clean_data/statistics/pseq_rrfa.rds")) #Mirlyn object from Method B
...
#plant_traits_MA <- readRDS("clean_data/statistics/plant_traits_rarefied.rds") # Loading rarefied data frame
```
...
rrfy_asv_table <- as.data.frame(t(rep_otu_df(pseq_rrfa))) |> # Rarefied counts
