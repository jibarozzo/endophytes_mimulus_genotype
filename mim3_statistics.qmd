...
load("clean_data/statistics/anova_m2_hell_margin.rda")
...
load("clean_data/statistics/anova_m3_hell_margin.rda")
...
load("clean_data/statistics/anova_m3_hell_term.rda")
...
load("clean_data/statistics/beta_perm3.rda")
...
load("clean_data/statistics/beta_dis4.rda")
...
load("clean_data/statistics/beta_perm4.rda")
...
# # Adding arros and labels (points at aplha = 0.05)
 ggsave(filename=file.path(path, "figures/dbRDA_full_model_labels.png"), plot = full_final_model, dpi=300, units=c("mm"), width=250, height=150)
