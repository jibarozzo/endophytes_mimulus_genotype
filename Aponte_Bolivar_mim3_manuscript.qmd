...
# Save the plot
ggplot2::ggsave(filename = file.path(path, "figures/supp_fig2.png"), plot = r2gg, dpi=300, units=c("mm"), width=300, height=250)
```
...
ggsave(filename = file.path(path, "figures/supp_fig3.png"), plot = supp_fig3, dpi=300, units=c("mm"), width=250, height=275)
