...
flextable(anova_table1) |>
  #flextable::set_caption("Table 3: ANOVA table for the dbRDA model with all cross-types.") |>
...
#| eval: true
#| tidy: true
#| tbl-cap: "Permutationa ANOVA for the best-fit dbRDA model with hybrid cross-types. Significance levels are represented by asterisks [*p* < .05 (\\*), *p* < .01 (\\*\\*), *p* < .001 (\\*\\*\\*), and *p* < .0001 (\\*\\*\\*\\*)]."
