...
#SBATCH --qos=long
#SBATCH --job-name BAR24_ddRAD_rmdup
#SBATCH --error /lustre/project/svanbael/bolivar/Mimulus_sequences/mim3_bioinformatics/errors/BAR24_ddRAD_rmdup.error     
#SBATCH --output /lustre/project/svanbael/bolivar/Mimulus_sequences/mim3_bioinformatics/errors/BAR24_ddRAD_rmdup.output  
...
#Run Python script
python rmdup_molbarcodes.py -p "BAR24" -s fastq.gz
