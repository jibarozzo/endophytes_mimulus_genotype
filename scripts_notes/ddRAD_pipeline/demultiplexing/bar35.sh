...
#SBATCH --qos=normal
#SBATCH --job-name BAR35_ddRAD_rmdup
#SBATCH --error /lustre/project/svanbael/bolivar/Mimulus_sequences/mim3_bioinformatics/errors/BAR35_ddRAD_rmdup.error     
#SBATCH --output /lustre/project/svanbael/bolivar/Mimulus_sequences/mim3_bioinformatics/errors/BAR35_ddRAD_rmdup.output  
...
#Run Python script
python rmdup_molbarcodes.py -p "BAR35" -s fastq.gz
